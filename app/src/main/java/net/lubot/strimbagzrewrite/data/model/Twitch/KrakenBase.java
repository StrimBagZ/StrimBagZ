...
@AutoValue
public abstract class KrakenBase {
    public abstract BaseToken token();
    ...
    public static JsonAdapter<KrakenBase> jsonAdapter(Moshi moshi) {  
        return new AutoValue_KrakenBase.MoshiJsonAdapter(moshi);
    }
}
